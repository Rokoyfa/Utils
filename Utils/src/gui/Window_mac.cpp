...
namespace r_utils
{
	namespace gui
	{
		...
		@end
			...
			: __id__(id), __title__(title), __dispatcher__(dispatcher), __width__(width), __height__(height), __isExpandable__(expandable), __isVisible__(false), __nsWindow__(nullptr)
		{
